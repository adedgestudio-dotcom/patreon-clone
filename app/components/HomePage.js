...
export default function HomePage() {
  ...
  useEffect(() => {
    document.title = "Buy Me A Chai - Support Creators with a Chai";
  }, []);
  ...
  return (
    <>
      <div className="main flex items-center justify-center gap-4 flex-col text-white h-[44vh] px-5 md:px-0 text-xs md:text-base">
        <div className="font-bold text-3xl md:text-5xl flex items-center justify-center gap-2 ">
          Buy Me A Chai
          <span>
        ...
        <p className=" text-center md:text-left">
          ...
          where your fans can buy you a chai. Start your journey today and connect
          with supporters who believe in your vision.
        </p>
        <p className="text-center md:text-left">
      ...
      <div className="section-1 text-white">
        <h2 className="text-center font-bold md:text-3xl text-xl my-4">
          Your supporters can buy you a chai
        </h2>
        <div className="item-sec flex justify-around gap-5 container mx-auto pb-32 pt-14 flex-col md:flex-row">
          ...
          <div className="line-divider bg-white h-1 opacity-10 md:hidden"></div>

          <div className="item space-y-3 flex flex-col items-center justify-center mt-4">
            <img
              className="bg-slate-400 rounded-full p-2"
              src="/coin.gif"
              width={88}
          ...
          <div className="line-divider bg-white h-1 opacity-10 md:hidden"></div>
          {/* md:hidden hides line in md+ screens */}
